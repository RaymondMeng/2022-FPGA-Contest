...
HD_PWD='C:/Users/lenovo/Desktop/2022FPGA-SOC/kyber_final/kyber_final.runs/c_shift_ram_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_shift_ram_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_shift_ram_10.tcl
