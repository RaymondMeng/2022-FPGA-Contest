...
#
# Generated by export_simulation on Wed Nov 02 11:37:54 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_10.sh' script.

./c_shift_ram_10.sh -reset_run
...
./c_shift_ram_10.sh -noclean_files

For more information on the script, please type './c_shift_ram_10.sh -help'.
